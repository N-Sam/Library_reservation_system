...
{
$id=$_GET['del'];
$sql = "delete from tbreservation  WHERE rid=:id";
...
<head>
    ...
    <title>Online Library Reservation System | Manage Reserved Books</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Manage Reservations</h4>
    </div>
     <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php 
$sqlr = "SELECT rid, bname, cat, author, isbn, price, stId, date_reserved, DATE_FORMAT(date_reserved,'%Y/%m/%d %H:%i:%s') as dt FROM tbreservation";
...
{    print($results);     ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                <a href="manage-reservation.php?del=<?php echo htmlentities($result->rid);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
