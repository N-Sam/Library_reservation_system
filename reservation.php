...
//test reservation be allowing

$sql="INSERT INTO tbreservation(bname,cat,author,isbn,price,stId) VALUES(:bookname,:category,:author,:isbn,:price,:studId)";
...
$query->bindParam(':studId',$bookid,PDO::PARAM_STR);
$query->execute();
...
<head>
    ...
    <title>Online Library Reservation System |Book Reservation</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Book This Book</h4>
...
<p class="help-block">An ISBN is an International Standard Book Number.ISBN Must be unique</p>
 ...
 <?php }} ?>
<button type="submit" name="reserve" class="btn btn-info">Reserve </button>
